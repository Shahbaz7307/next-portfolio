...
export default function CTASectionProjects({
        ...
        <div className="relative overflow-hidden rounded-[40px] border border-zinc-800 bg-zinc-900/40 p-8 sm:p-12 md:p-20 backdrop-blur-xl">
          ...
          <div className="relative z-10">
            ...
            <h2 className="max-w-5xl text-5xl sm:text-6xl md:text-8xl font-semibold tracking-[-4px] leading-none">
              Building modern websites and web applications that drive results.
            </h2>

            <p className="mt-10 max-w-2xl text-lg leading-relaxed text-zinc-400">
              Whether you need a WordPress website, a React or Next.js
              application, a Vue.js frontend or a custom business platform, I
              can help transform your ideas into fast, responsive and scalable
              digital products.
            </p>
